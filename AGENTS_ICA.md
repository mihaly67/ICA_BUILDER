...
1. **LÉPÉS: RAG Katalógus Hivatkozás (Meta-RAG)**
   - Határozd meg, mely külső rendszerek/repók szükségesek a feladathoz.
   - *Példa:* "1. Lépés: A probléma megoldásához a katalógusból (pl. `mcp-structured-thinking`, `LLM-sycophancy` vagy releváns RAG) merítek."
...
Ez az a "burok", amely biztosítja, hogy kényszerítve vagy a System 2 gondolkodásra és az önellenőrzésre.
